...
namespace OPCFoundation.ClientLib.Filters
{
    /// <summary>
    ...
    public class FilterDefinition
    {
        ...
        {
            // get the supertypes.
            ReferenceDescriptionCollection supertypes = AppUtils.BrowseSuperTypes(session, eventTypeId, false);
            ...
            Dictionary<NodeId, QualifiedNameCollection> foundNodes)
        {
            ...
            ReferenceDescriptionCollection children = AppUtils.Browse(session, nodeToBrowse, false);
