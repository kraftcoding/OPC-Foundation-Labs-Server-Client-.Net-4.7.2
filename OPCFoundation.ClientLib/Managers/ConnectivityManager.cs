...
namespace OPCFoundation.ClientLib.Controllers
{
    internal class ConnectivityManager
    {
        ...
        internal Session Connect(string endPoint, bool useSecurity)
        {
            ...
            EndpointDescription endpointDescription = Opc.Ua.Client.Controls.ClientUtils.SelectEndpoint(endPoint, useSecurity);
        ...
        {           
            ...
            {
                Opc.Ua.Client.Controls.ClientUtils.HandleException("Session_KeepAlive", exception);
            }
        }
        ...
        {         
            ...
            try
            {
                ...
                {                    
                    Utils.Trace("Auto accep untrusted certificate is false");
                }
            }
            catch (Exception exception)
            {
                Opc.Ua.Client.Controls.ClientUtils.HandleException("CertificateValidator_CertificateValidation", exception);
            }
        }
        ...
        {          
            ...
            {
                Opc.Ua.Client.Controls.ClientUtils.HandleException("Server_ReconnectComplete", exception);
            }
        }
