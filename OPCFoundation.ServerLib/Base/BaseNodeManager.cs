...
using MonitoredNode = OPCFoundation.ServerLib.Model.MonitoredNode;
using NodeHandle = OPCFoundation.ServerLib.Model.NodeHandle;

namespace OPCFoundation.ServerLib.Base
{
    /// <summary>
    ...
    /// </remarks>
    public class BaseNodeManager : INodeManager, INodeIdFactory, IDisposable
    {
        #region Constructors
        /// <summary>
        /// Initializes the node manager.
        /// </summary>
        protected BaseNodeManager(
